import { ItExportAnalysis } from "@/components/it-export-analysis";
import { SiteHeader } from "@/components/site-header";
import { getItExportData } from "@/lib/econ-data";
  ...
  return (
    <div className="min-h-screen bg-[#f7f9fc] text-slate-900">
      ...
      <main className="mx-auto max-w-[1200px] px-4 py-8 sm:px-8 sm:py-12">
        ...
        <section className="rounded-2xl border border-slate-200/80 bg-white p-4 shadow-sm sm:p-6"><ItExportAnalysis data={data} /></section>
